...
export default function HeroSection() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <motion.a  className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-pink-100 bg-pink-200/15 cursor-pointer"
            ...
            >
                Start building your{" "}
                <span className="move-gradient px-3 rounded-xl text-nowrap">React.js site.</span>
            </motion.h1>
